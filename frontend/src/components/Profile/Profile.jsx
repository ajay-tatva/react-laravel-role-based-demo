import { Avatar, Card, CardBody, Tooltip, Typography } from "@material-tailwind/react";
        ...
        <CardBody className="overflow-x-scroll p-5">
          <div className="flex items-center gap-4 p-3">
            ...
            <div className="flex">
              ...
              <div className="pl-3">
                <Tooltip color="blue" content="Edit Profile" className="bg-blue-500 shadow-xl shadow-black/10">
                  <Link to="edit-profile">
                    <PencilIcon color="blue" className="h-4 w-4 cursor-pointer" />
                  </Link>
                </Tooltip>
              </div>
            </div>
