...
function Dashboard() {
  ...
  const [dailyTotalUsersChart, setDailyTotalUsersChart] = useState({
    type: "bar",
    height: 270,
    series: [
      {
  ...
  const getDashboardData = useCallback(async () => {
    ...
    if (data.flag) {
      ...
      var dailyTotalUsersChartData = [];
      var dailyTotalUsersChartCategories = [];
      data.data.dailyTotalUsers.map((dailyUser, key) => {
      ...
      setDailyTotalUsersChart({
        ...
        options: {
          ...
          xaxis: {
            ...dailyTotalUsersChart.options.xaxis[0],
